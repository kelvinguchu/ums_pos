...
export default function SignUp() {
  ...
  return (
    <div className={`${geistMono.className} flex flex-col items-center justify-center space-y-4 min-h-screen bg-background`}>
      ...
      <Card className='w-[350px]'>
        ...
        <CardFooter>
          <p className='text-sm text-center w-full'>
            Already have an account? <a href="/signin" className="text-[#000080] hover:underline">Sign in</a>
          </p>
        </CardFooter>
      </Card>
    </div>
